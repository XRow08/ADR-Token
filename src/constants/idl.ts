export const idl = {
  address: "GKf6NkHokaNXcov4kgPqftFrd9QfJMcgRwaCVSWc5yTz",
  metadata: {
    name: "adr_token_mint",
    version: "0.1.0",
    spec: "0.1.0",
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [74, 230, 119, 25, 252, 188, 254, 177],
      accounts: [
        {
          name: "admin",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [58, 176, 6, 207, 250, 176, 194, 85],
      accounts: [
        {
          name: "payer",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [216, 204, 65, 234, 19, 243, 233, 25],
      accounts: [
        {
          name: "admin",
          writable: true,
    ...
    },
    {
      ...
      discriminator: [155, 213, 140, 249, 53, 59, 20, 5],
      accounts: [
        {
          name: "admin",
          writable: true,
            ...
            seeds: [
              {
                kind: "const",
                value: [
                  115, 116, 97, 107, 101, 95, 97, 117, 116, 104, 111, 114, 105,
                  116, 121,
                ],
              },
            ],
    ...
    },
    {
      ...
      discriminator: [83, 37, 160, 55, 64, 14, 23, 60],
      accounts: [
        {
          name: "admin",
          writable: true,
  ...
  accounts: [
    ...
    {
      name: "NFTMetadata",
      discriminator: [149, 0, 165, 163, 182, 162, 192, 134],
    },
    {
      name: "StakeAccount",
  ...
  events: [
    {
      ...
      discriminator: [158, 144, 170, 167, 15, 184, 45, 12],
    },
    {
    ...
    {
      name: "StakingEvent",
      discriminator: [214, 146, 230, 38, 71, 208, 207, 86],
    },
    {
      name: "TokenBurnEvent",
      discriminator: [51, 27, 242, 215, 185, 35, 71, 20],
    },
    {
      name: "UnstakingEvent",
      discriminator: [249, 22, 125, 15, 215, 161, 9, 170],
    },
  ],
  errors: [
    {
