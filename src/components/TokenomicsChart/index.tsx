...
export const TokenomicsChart = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-start pb-20 overflow-hidden bg-[#0F0F0F]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-[1200px] px-6 gap-12 mt-2">
